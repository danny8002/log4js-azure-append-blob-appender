...
declare module "azure-storage" {
  ...
  module azurestorage {
    ...
    module services {
      ...
      module table {
        ...
        export module TableUtilities {
          ...
          */
          module entityGenerator {
            ...
            function Guid(value: __NodeUUID.UUID|string|Buffer): EntityProperty<__NodeUUID.UUID>;
        ...
        export var TableQuery: {
           ...
           */
          guidFilter(propertyName: string, operation: string, value: __NodeUUID.UUID | string): string;
    ...
    */
    ...
    export function generateAccountSharedAccessSignature(storageAccountOrConnectionString: string, storageAccessKey: string, sharedAccessAccountPolicy: common.SharedAccessPolicy): void;
